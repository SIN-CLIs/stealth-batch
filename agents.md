# AGENTS.md — Agenten-Anleitung (stealth-batch)
...
4. Doc-Health checken: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo stealth-batch`

## Repo-Info

- **Layer**: 💰 Batch
- **Beschreibung**: Batch Client — eligible Tasks → Fireworks Batch
